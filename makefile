OBJDIR=build
OBJECTS= utils.o math_extension.o reduced_encoder.o sequential_encoder.o product_encoder.o duplex_encoder.o duplex_nsc_encoder.o encoder.o bdd.o clause_cont.o cadical_clauses.o antibandwidth_encoder.o
...
$(OBJDIR)/antibandwidth_encoder.o : $(SRCDIR)/antibandwidth_encoder.cpp $(SRCDIR)/antibandwidth_encoder.h $(SRCDIR)/reduced_encoder.h $(SRCDIR)/sequential_encoder.h $(SRCDIR)/product_encoder.h $(SRCDIR)/duplex_encoder.h $(SRCDIR)/duplex_nsc_encoder.h $(SRCDIR)/utils.h $(SRCDIR)/math_extension.h $(SRCDIR)/clause_cont.h $(SRCDIR)/cadical_clauses.h
	g++ $(FLAGS) $(STANDARD) -I$(CADICAL_INC) -c $< -o $@
...
$(OBJDIR)/duplex_nsc_encoder.o : $(SRCDIR)/duplex_nsc_encoder.cpp $(SRCDIR)/duplex_nsc_encoder.h $(SRCDIR)/encoder.h $(SRCDIR)/math_extension.h 
	g++ $(FLAGS) $(STANDARD) -c $< -o $@
